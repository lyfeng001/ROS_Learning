...
// pack position
    ...
    if (generate == 0){
      ...
      joint5.data = 0;
      joint6.data = 0;
      joint7.data = 0.70*(1-exp(-theta));
      joint8.data = 0;
      joint9.data = 0.70*(1-exp(-theta));
      joint10.data = 0;
      joint11.data = 0.70*(1-exp(-theta));
      joint12.data = 0;
      joint13.data = 0.70*(1-exp(-theta));
      joint14.data = 0;
      joint15.data = 0.70*(1-exp(-theta));
      joint16.data = 0;
      joint17.data = 0.70*(1-exp(-theta));
      joint18.data = 0;
    }
   else if(generate == 1){
      joint1.data = 0.30*(1-exp(-theta));
      joint2.data = 0;
      joint3.data = 0.30*(1-exp(-theta));
      joint4.data = 1.45*(1-exp(-theta));
      joint5.data = -1.35*(1-exp(-theta));
      joint6.data = 1.49*(1-exp(-theta));
      joint7.data = 0.70;
      joint8.data = 0;
      joint9.data = 0.70;
      joint10.data = 0;
